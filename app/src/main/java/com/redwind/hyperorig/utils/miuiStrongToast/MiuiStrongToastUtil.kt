package com.redwind.hyperorig.utils.miuiStrongToast
...
import com.redwind.hyperorig.utils.miuiStrongToast.data.IconParams
import com.redwind.hyperorig.utils.miuiStrongToast.data.Left
import com.redwind.hyperorig.utils.miuiStrongToast.data.Right
import com.redwind.hyperorig.utils.miuiStrongToast.data.StringToastBean
import com.redwind.hyperorig.utils.miuiStrongToast.data.TextParams
...
object MiuiStrongToastUtil {
    ...
    fun showStringToast(context: Context, text: String?, colorType: Int) {
        ...
        try {
            ...
            Log.e("HyperOriG", "Failed to show HyperOS String Toast")
        }
    }
    ...
    fun showPodsBatteryToast(
        ...
        try {
            ...
            Log.e("HyperOriG", "Failed to show Pods Battery Toast")
        }
    }
    ...
    fun showPodsBatteryToastByMiuiBt(
        ...
        val intent = Intent("com.redwind.hyperorig.action.sendstrongtoast")
    ...
    fun showPodsNotificationByMiuiBt(
        ...
        val intent = Intent("com.redwind.hyperorig.action.updatepodsnotification")
        intent.putExtra("batteryParams", batteryParams)
    ...
    fun cancelPodsNotificationByMiuiBt(
        ...
        val intent = Intent("com.redwind.hyperorig.action.cancelpodsnotification")
        intent.putExtra("device", device)
        intent.`package` = "com.xiaomi.bluetooth"
        context.sendBroadcast(intent)
    }
